...
function validatePhone()
{
    ...
    {
        phoneError.innerHTML="enter valid phone nmber";
        return false;
    }
...
function validateEmail()
{
    ...
    if(!email.match(/^\w+([\.-]?\w+)*@\w+([-]?\w+)*\.[a-z]{2,3}$/))
    {
        emailError.innerHTML="Ivalid email";
        return false;
    }
...
function validateForm()
{
    if(!validateName()||!validatePhone()||!validateEmail()||!validateMessage())
    {
        ...
        setTimeout(function(){submitError.style.opacity="0"},1000);
        return false;
    }
}